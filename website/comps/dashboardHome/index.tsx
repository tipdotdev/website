        ...
        <div className="flex flex-col w-full ml-10 mb-10">
            <div className="text-center flex-col p-5 bg-base-200 w-full rounded-xl items-center">
                ...
                <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="grid grid-cols-2 justify-center items-start text-left bg-base-300 w-full rounded-xl p-5">
                        ...
                        <div className="flex flex-row justify-between items-center w-full">
                            ...
                            <div className="flex flex-col justify-start items-start">
                                ...
                                <h1 className="text-5xl font-bold mt-5">10,482</h1>
                            </div>


                        </div>

                        <div className="flex flex-row justify-between w-full gap-2 mt-5">
                    ...
                    <div className="col-span-2 flex flex-col justify-center items-start text-left bg-base-300 w-full rounded-xl p-5">
                        <div className="flex flex-row justify-between items-center w-full">
                        ...
                        <div className="flex flex-col justify-between w-full gap-2 mt-5">
                            ...
                            {recentEvents.length == 0 ? (
                                <div className="flex flex-col justify-center items-center text-center bg-base-300 rounded-xl w-full">
