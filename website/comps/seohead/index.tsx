...
export default function SEOHead(props:any) {
    return (
        <Head>
            ...
            <link rel="icon" href={props.icon || "/images/webp/logo-rounded-corner.webp"} />
            ...
            <meta name="image" content={props.image || "/images/webp/logo-rounded-corner.webp"} />
            ...
            <meta property="og:image" content={props.image || "/images/webp/logo-rounded-corner.webp"} />
            <meta property="og:site_name" content={'tip.dev'} />

            <meta name="theme-color" content="#fe7ac6" />
            <link rel="apple-touch-icon" sizes="180x180" href="/images/webp/logo-rounded-corner.webp" />

            <meta property="twitter:image" content={props.image || "https://tip.dev/images/webp/logo-rounded-corner.webp"} />
            <meta property="twitter:card" content={props.largeImage || "https://tip.dev/images/webp/logo-rounded-corner.webp"} />
