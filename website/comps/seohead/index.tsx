...
export default function SEOHead(props:any) {
    return (
        <Head>
            ...
            <link rel="icon" href={props.icon || "/static/logo-rounded.png"} />
            ...
            <meta name="image" content={props.image || "/static/logo-rounded.png"} />
            ...
            <meta property="og:image" content={props.image || "/static/logo-rounded.png"} />
            <meta property="og:site_name" content={'tip.dev'} />

            <meta name="theme-color" content="#fe7ac6" />
            <link rel="apple-touch-icon" sizes="180x180" href="/static/logo-rounded.png" />

            <meta property="twitter:image" content={props.image || "https://tip.dev/static/logo-rounded.png"} />
            <meta property="twitter:card" content={props.largeImage || "https://tip.dev/static/logo-rounded.png"} />
