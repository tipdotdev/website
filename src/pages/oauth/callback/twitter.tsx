		...
		<main
  		...
  		>	
            ...
            <div className="flex flex-row justify-center items-center ">
                ...
                <Image src={`/images/webp/twitter-logo-bg.webp`} alt='Google logo' width={100} height={100} className='ml-3 border-zinc-700 border rounded-full shadow-md shadow-black' />
            </div>
