...
export default function DashboardFooter() {
    return (
        <>
            <footer className="footer px-10 py-4 bg-base-100 text-zinc-400 w-screen">
