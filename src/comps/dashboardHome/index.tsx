...
export default function DashboardHome(props: any) {
    ...
    const calculateTotalIncome = () => {
        ...
        setTotalIncome({
            total: (total / 100).toLocaleString("en-US", {
                style: "currency",
    ...
    const getSupporters = async () => {
        ...
        const res = await fetch(
            `${process.env.NEXT_PUBLIC_API_URL}/v1/user/me/supporters/${timeRange.supporters.value}`,
            {
                method: "GET",
                headers: {
                    Authorization: `Bearer ${token}`
    ...
    const calculateRecentEvents = () => {
        ...
        for (let i = 0; i < user?.incomeEvents?.length; i++) {
            ...
            events.push({
                ...
                amount: (user?.incomeEvents[i].amount / 100).toLocaleString("en-US", {
                    style: "currency",
                    currency: user?.currency || "USD",
                    minimumFractionDigits: 0
                }),
                ...
                <div className="grid grid-cols-4 gap-2">
                    <div className="col-span-4 flex flex-row justify-between items-center bg-base-200 p-5 rounded-xl">
                        <div className="flex flex-row justify-start items-center">
                            <div className="w-24 flex">
                                <a className="" href="/dashboard/account">
                                    <Avatar
                                        user={user}
                            ...
                            <div className="flex flex-col justify-start items-start">
                                <h1 className="text-4xl font-extrabold ml-5">
                                ...
                                <div className="flex flex-row justify-start items-center mt-2 ml-5">
                                    ...
                                    <div className="tooltip tooltip-bottom" data-tip="Your page is live!">
                                        <a
                                            href={`https://tip.dev/${user?.username}`}
                                            className="text-md ml-2 font-code link link-hover link-primary text-white"
                                        >
                        ...
                        <div className="flex flex-row justify-between items-center w-full">
                            <div className="flex flex-col justify-start items-start w-full">
                                ...
                                {pageViewsLoading ? (
                                    ...
                                    <h1 className="text-5xl font-bold mt-5 w-full flex flex-row">
                    ...
                    <div className="col-span-4 flex flex-col justify-center items-start text-left bg-base-200 w-full rounded-xl p-5">
                        ...
                        <div className="flex flex-col justify-between w-full gap-2 mt-5">
                                ...
                                <>
                                    {recentEvents.length == 0 ? (
                                        <div className="flex flex-row justify-center items-center text-center bg-base-200 rounded-xl w-full border-1 border-zinc-700 border py-10">
                                            ...
                                            <h1 className="text-xl font-nomal font-code text-zinc-400">
                                                No Recent Events
                                            </h1>
                                        </div>
                                    ) : (
                                        <>
                                            {recentEvents.map((event: any) => {
                                                return <IncomeEventDashboard event={event} />;
                                            })}
                                        </>
                                    )}
                                </>
                            ...
                            <a href="/dashboard/history" className="btn btn-ghost mt-2">
                                View More
                            </a>
                        </div>
                    </div>
